...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE etudiants SET nom = ?, prenom = ?, date_naissance = ?, email = ?, telephone = ?, niveau = ?, archive = ? WHERE id = ?";
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        mysqli_stmt_bind_param($stmt, "ssssssii", $nom, $prenom, $date_naissance, $email, $tel, $niveau, $archive, $id);
